 ...
 */
"use strict";
const moment = require("moment"), docusign = require("docusign-esign"), dsConfig = require("../dsconfig.js").config, passport = require("passport"), { promisify } = require("util"), // http://2ality.com/2017/05/util-promisify.html
baseUriSuffix = "/restapi", tokenReplaceMinGet = 60; // For a form Get, the token must expire at least this number of
